...
def close_windows():
    print(
        "Exiting... (if you started downloading the assets, this might take a few seconds)"
    )
    raise SystemExit
...
class MainWindow:
    ...
    def css_success_callback(self):
        ...
        self.create_mount_progress(
            self.gmodPathVar.get(),
            self.cssPathVar.get(),
            self.mount_success_callback,
            self.mount_abort_callback,
        )
